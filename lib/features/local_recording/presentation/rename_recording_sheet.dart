...
abstract final class RenameRecordingSheet {
  static Future<String?> show(BuildContext context, {required String title}) {
    return showModalBottomSheet<String>(
      ...
      builder: (context) => _RenameRecordingSheet(initialTitle: title),
    );
  }
}

class _RenameRecordingSheet extends StatefulWidget {
  const _RenameRecordingSheet({required this.initialTitle});

  final String initialTitle;

  @override
  State<_RenameRecordingSheet> createState() => _RenameRecordingSheetState();
}

class _RenameRecordingSheetState extends State<_RenameRecordingSheet> {
