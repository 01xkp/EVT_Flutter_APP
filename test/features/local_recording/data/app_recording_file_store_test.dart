...
void main() {
  ...
  test('recovers a readable partial file and reports a missing file as absent', () async {
  ...
  test('rejects empty captures and unsafe relative paths', () async {
    ...
    await expectLater(store.finalize(pending), throwsA(isA<RecordingFileException>()));
    await expectLater(
